/*
  Fork of https://github.com/SassNinja/postcss-extract-media-query/ without additional config load
  Ref: https://twitter.com/DavidWells/status/1720207365327528252
*/
    ...
    Once(root, { result }) {
      ...
      if (opts.output.path) {
        root.walkAtRules('media', (atRule) => {
          ...
          const queryname =
            opts.queries[query] || (opts.extractAll && kebabCase(query))
